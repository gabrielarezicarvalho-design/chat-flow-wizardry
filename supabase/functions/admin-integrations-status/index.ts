...
const PLATFORM_SECRETS = [
  ...
  { name: 'UZAPI_BASE_URL_PROD', label: 'UAZAPI Base URL (Prod)', category: 'whatsapp', description: 'URL do servidor UAZAPI produção' },
  { name: 'UZAPI_ADMIN_TOKEN_PROD', label: 'UAZAPI Admin Token (Prod)', category: 'whatsapp', description: 'Token admin UAZAPI produção' },
  { name: 'UZAPI_BASE_URL_TESTE', label: 'UAZAPI Base URL (Teste)', category: 'whatsapp', description: 'URL do servidor UAZAPI teste' },
  { name: 'UZAPI_ADMIN_TOKEN_TESTE', label: 'UAZAPI Admin Token (Teste)', category: 'whatsapp', description: 'Token admin UAZAPI teste' },
  { name: 'UZAPI_ENV', label: 'UAZAPI Ambiente Ativo', category: 'whatsapp', description: 'prod ou teste' },
