...
${mensagem}`;
    ...
    try {
      ...
      console.log("📋 Configs Telegram encontradas:", telegramConfigs?.length || 0);
...
${mensagem}`;
          ...
          if (TELEGRAM_BOT_TOKEN) {
            try {
              ...
              if (telegramResponse.ok) {
                ...
                console.error("❌ Erro do Telegram:", telegramResult);
              }
            } catch (telegramError: any) {
              console.error("❌ Erro ao enviar para Telegram:", telegramError.message);
            }
        ...
        console.log("ℹ️ Nenhuma config de Telegram encontrada para este usuário");
      }
    } catch (telegramError: any) {
