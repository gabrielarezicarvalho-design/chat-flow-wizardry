...
export const HttpNode = ({ data, selected }: HttpNodeProps) => {
  ...
  return (
    <div 
      className={`
        ...
        ${selected ? 'ring-2 ring-indigo-500 shadow-md' : 'border-gray-200 hover:shadow-md'}
      `}
    >
      <Handle 
        type="target" 
        position={Position.Left}
        className="!bg-indigo-500 !w-3 !h-3 !border-2 !border-white !-left-1.5"
      />
      ...
      <Handle 
        ...
        className="!bg-indigo-500 !w-3 !h-3 !border-2 !border-white !-right-1.5"
      />
