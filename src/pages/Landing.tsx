    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <section id="recursos" className="mx-auto max-w-6xl px-6 py-24">
        ...
        <div className="mt-12 max-w-3xl mx-auto">
          <div className="rounded-2xl border border-slate-200 bg-white shadow-[0_20px_60px_-30px_rgba(0,77,255,0.35)] overflow-hidden">
            ...
            <div className="flex items-center gap-3 px-4 py-3 border-b border-slate-100">
              ...
              <div className="flex-1 flex items-center gap-2 rounded-full bg-slate-50 border border-slate-100 px-4 py-1.5 text-sm text-slate-500">
            ...
            {/* Stylized map */}
            <div className="relative mx-4 mt-4 h-64 rounded-xl overflow-hidden bg-[#f1f0fb]">
              {/* subtle grid lines */}
              <div
              ...
              />
              {/* streets */}
              <div className="absolute inset-x-0 top-1/2 h-px bg-slate-300/60 rotate-[-8deg]" />
              <div className="absolute inset-y-0 left-1/2 w-px bg-slate-300/60 rotate-[6deg]" />
              {/* glow */}
              <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 h-40 w-40 rounded-full bg-[#004DFF]/20 blur-3xl" />
              {/* pins */}
              {[
                { top: "18%", left: "44%" },
                { top: "28%", left: "22%" },
                ...
                <div
                  key={i}
                  className="absolute -translate-x-1/2 -translate-y-full drop-shadow-[0_4px_8px_rgba(0,77,255,0.35)]"
                  style={{ top: p.top, left: p.left }}
                >
                  <MapPin className="h-7 w-7 text-[#004DFF] fill-[#004DFF]/30" strokeWidth={2} />
                </div>
              ))}
            </div>
            ...
            <div className="p-4 space-y-2">
              {[
                ...
                <div key={l.name} className="flex items-center justify-between rounded-xl px-3 py-3 hover:bg-slate-50 transition">
                  <div className="flex items-center gap-3">
                    <div className="h-9 w-9 rounded-lg bg-[#004DFF]/10 flex items-center justify-center">
                      <Building2 className="h-4 w-4 text-[#004DFF]" />
                    </div>
                    <div>
                  ...
                  <span className="text-xs font-medium text-emerald-700 bg-emerald-100 px-2.5 py-1 rounded-full">novo</span>
                </div>
              ))}
            </div>
          </div>
