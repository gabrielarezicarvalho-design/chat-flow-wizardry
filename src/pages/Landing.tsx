          ...
          <div>
            ...
            <div className="hero-reveal hero-d5 mt-12 flex flex-wrap items-center gap-8">
              {["Kaja", "BOOBOO", "SENSE", "Tangerine"].map((b) => (
                <span key={b} className="font-space-grotesk text-xl font-bold tracking-wide text-slate-900 opacity-40">
                  {b}
                </span>
              ))}
            </div>
            <p className="hero-reveal hero-d6 mt-6 text-base text-slate-600">
