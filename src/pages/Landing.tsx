        ...
        <div className="mx-auto max-w-[1280px] px-6 text-center">
          ...
          <div className="mt-24 max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
              {/* Card Sem Next Pro */}
              <div className="bg-[#FFF8F8] border border-[#FBEAEA] rounded-[32px] p-6 relative overflow-hidden flex flex-col shadow-sm h-full">
                <div className="flex items-center gap-3 mb-6">
                  <div className="h-8 w-8 rounded-full bg-[#F43F5E]/10 flex items-center justify-center text-[#F43F5E]">
                    <X className="h-4 w-4" strokeWidth={2.5} />
                  </div>
                  <span className="text-[#991B1B] font-bold text-lg font-space-grotesk">Sem Next Pro</span>
                </div>
                ...
                <div className="space-y-3 mb-6">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-3 text-[#8E8E93] text-[14px]">
                      <item.icon className="h-4 w-4 text-[#E5A5A5]" strokeWidth={1.5} />
                      {item.text}
                    </div>
                  ))}
                </div>

                <div className="mt-auto pt-4 border-t border-[#F2E2E2]">
                  <span className="text-[#E57373] font-bold text-[10px] tracking-wide mb-4 block font-space-grotesk uppercase text-left">CUSTOS SEPARADOS / MÊS</span>
                  ...
                  <div className="flex justify-between items-center mt-6 pt-4 border-t border-[#F2E2E2]">
                    <span className="font-bold text-[#1C1C1E] text-sm">Total estimado</span>
                    <span className="text-[#F43F5E] font-bold text-lg font-space-grotesk">
                      R$ 3.300+<span className="text-[10px] font-normal text-[#8E8E93] ml-1">/mês</span>
                    </span>
                  </div>
                </div>
              </div>
              ...
              {/* Card Com Next Pro */}
              <div className="bg-[#F0FDF4]/50 border border-[#DCFCE7] rounded-[32px] p-6 relative overflow-hidden flex flex-col h-full">
                <div className="flex items-center gap-3 mb-6">
                  <div className="h-8 w-8 rounded-full bg-white flex items-center justify-center text-[#10B981] shadow-sm">
                    <Check className="h-4 w-4" strokeWidth={3} />
                  </div>
                  <span className="text-[#10B981] font-bold text-lg font-space-grotesk">Com Next Pro</span>
                </div>
                ...
                <div className="space-y-3 mb-6">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-3 text-slate-700 font-medium text-[14px]">
                      <item.icon className="h-4 w-4 text-[#10B981] opacity-70" />
                      {item.text}
                    </div>
                  ))}
                </div>

                <div className="mt-auto border-t border-[#DCFCE7] pt-4">
                  <span className="text-[#10B981] font-bold text-[9px] uppercase tracking-wider mb-4 block">Tudo incluso nos planos Pro e Premium</span>
                  <div className="space-y-1.5">
                    {[
                  ...
                  <div className="mt-6 pt-4 border-t border-dashed border-[#DCFCE7]">
                    <div className="flex justify-between items-center">
                      <div>
                        <span className="font-bold text-slate-900 block text-xs">Economize até</span>
                        <span className="text-[9px] text-slate-400">Comparado a contratar separadamente</span>
                      </div>
                      <span className="text-[#10B981] font-bold text-lg font-space-grotesk">R$ 2.800+<span className="text-[10px] font-normal text-slate-400">/mês</span></span>
                    </div>
                  </div>
                </div>
              </div>
