    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <header className="sticky top-0 z-40 bg-[#0b0d0b]/95 backdrop-blur">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6">
          <div className="flex items-center gap-10">
            <div className="flex items-center gap-2 font-bold text-5xl font-space-grotesk text-white">
              <img
                src={logoAurora.url}
                alt="NEXT PRO"
            ...
            <nav className="hidden lg:flex items-center gap-8 text-5xl text-slate-200">
      ...
      <section className="relative overflow-hidden bg-[#0b0d0b]">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-6 pb-24 pt-16 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-8 max-w-lg text-5xl leading-relaxed text-slate-400">
            ...
            <div className="mt-10">
              <Link to="/auth">
                <Button size="lg" className="h-14 rounded-xl bg-[#004DFF] px-9 text-5xl font-semibold text-white hover:bg-[#0040d6]">
                  Testar grátis <ArrowRight className="ml-2 h-4 w-4" />
                </Button>
              </Link>
            </div>
            <div className="mt-5 flex items-center gap-2 text-5xl text-slate-400">
            ...
            <div className="mt-12 flex flex-wrap items-center gap-8 opacity-40">
              {["Kaja", "BOOBOO", "SENSE", "Tangerine"].map((b) => (
                <span key={b} className="font-space-grotesk text-5xl font-bold tracking-wide text-white">
                  {b}
                </span>
              ))}
            </div>
            <p className="mt-6 text-5xl text-slate-400">
      ...
      <section className="bg-gradient-to-b from-white to-slate-50">
        <div className="mx-auto max-w-6xl px-6 pt-20 pb-16 grid md:grid-cols-2 gap-12 items-center">
          <div className="text-center md:text-left">
            ...
            <h2 className="mt-5 text-5xl md:text-5xl font-bold tracking-tight leading-[1.05]">
              Encontra clientes.
              <br />
            ...
            <p className="mt-6 max-w-xl text-5xl text-slate-600 md:mx-0 mx-auto">
            ...
            <div className="mt-10 grid grid-cols-3 gap-6 max-w-lg md:mx-0 mx-auto">
              {stats.slice(0, 3).map((s) => (
                <div key={s.label} className="text-center md:text-left">
                  <div className="text-5xl md:text-5xl font-bold text-[#004DFF]">
                    {s.value}
                  </div>
            ...
            <div className="relative rounded-3xl bg-white shadow-2xl p-6 text-left">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-5xl font-semibold text-slate-900">Aurora AI</div>
              ...
              <div ref={scrollRef} className="mt-6 h-[260px] space-y-3 overflow-y-auto flex flex-col">
                ...
                {chatMessages.slice(0, visibleCount).map((msg, idx) => {
                  ...
                  if (msg.sender === "client") {
                    return (
                      <div
                        key={msg.id}
                        className="max-w-[75%] rounded-2xl bg-slate-100 px-4 py-2 text-5xl text-slate-700 animate-fade-in"
                        style={{ animationDelay: `${idx * 50}ms` }}
                      >
                        {msg.content}
                      </div>
                  ...
                  return (
                    <div
                      key={msg.id}
                      className="ml-auto max-w-[80%] rounded-2xl bg-primary px-4 py-3 text-5xl text-white shadow-md animate-fade-in"
                      style={{ animationDelay: `${idx * 50}ms` }}
                    >
                ...
                {userMessages.map((m) => {
                  ...
                  if (m.kind === "text") {
                    return isAI ? (
                      <div key={m.id} className="ml-auto max-w-[80%] rounded-2xl bg-primary px-4 py-3 text-5xl text-white shadow-md animate-fade-in">
                        <div className="text-[11px] font-semibold opacity-90 mb-1">✦ Aurora AI</div>
                        {m.content}
                      </div>
                    ) : (
                      <div key={m.id} className="max-w-[75%] rounded-2xl bg-slate-100 px-4 py-2 text-5xl text-slate-700 animate-fade-in">
                        {m.content}
                      </div>
                    );
                  }
                  if (m.kind === "file") {
                    return (
                      <div key={m.id} className="max-w-[75%] rounded-2xl bg-slate-100 p-2 text-5xl text-slate-700 animate-fade-in">
                        {m.previewUrl ? (
                  ...
                  return (
                    <div key={m.id} className={`${isAI ? "ml-auto bg-primary text-white" : "bg-slate-100 text-slate-700"} max-w-[75%] rounded-2xl px-3 py-2 text-5xl flex items-center gap-2 animate-fade-in`}>
                      <button
                        type="button"
                ...
                {showTyping && (
                  <div className="max-w-[55%] rounded-2xl bg-slate-100 px-4 py-3 text-5xl text-slate-700 animate-fade-in">
                ...
                <div className="mt-3 grid grid-cols-10 gap-1 rounded-2xl bg-slate-50 border border-slate-200 p-2 animate-fade-in">
                  {EMOJIS.map((e) => (
                    <button
                      ...
                      className="h-7 w-7 flex items-center justify-center rounded-md hover:bg-slate-200 text-5xl"
                    >
                      {e}
                    </button>
                  ))}
              ...
              {isRecording ? (
                <div className="mt-6 flex items-center gap-3 rounded-full bg-red-50 px-3 py-2 text-red-600 border border-red-200">
                  ...
                  <span className="flex-1 text-5xl font-medium">Gravando… 0:{String(recordSeconds).padStart(2, "0")}</span>
                  <button
                    type="button"
                ...
                <div className="mt-6 flex items-center gap-2 rounded-full bg-slate-100 px-3 py-2 text-slate-500">
                  ...
                  <input
                    ...
                    className="flex-1 bg-transparent text-5xl text-slate-700 placeholder:text-slate-400 outline-none min-w-0"
                  />
                  {inputValue.trim() ? (
                    <button
                      type="button"
        ...
        <div className="border-y border-slate-200 bg-white">
          <div className="mx-auto max-w-6xl px-6 py-5 flex flex-wrap items-center justify-center gap-x-12 gap-y-2">
            ...
            {["Rio de Janeiro", "São Paulo", "Distrito Federal", "Mato Grosso", "Santa Catarina", "Rio Grande do Sul"].map((c) => (
              <span key={c} className="text-5xl text-slate-600">
                {c}
              </span>
            ))}
          </div>
      ...
      <section id="recursos" className="mx-auto max-w-6xl px-6 py-24">
        <div className="text-center">
          ...
          <h2 className="mt-4 text-5xl md:text-5xl font-bold tracking-tight text-slate-900">
            Encontre clientes{" "}
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={step.title} className="flex items-center gap-4 rounded-xl px-3 py-3 hover:bg-slate-50 transition">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="font-semibold text-slate-900 text-5xl">{step.title}</div>
        ...
        <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={f.title} className="rounded-2xl border border-slate-200 bg-white p-5 hover:border-primary/40 hover:shadow-sm transition">
              ...
              <div className="mt-3 font-semibold text-slate-900 text-5xl">{f.title}</div>
      ...
      <section id="ia" className="bg-slate-50 py-24">
        <div className="mx-auto max-w-6xl px-6">
          <div className="text-center">
            ...
            <h2 className="mt-3 text-5xl md:text-5xl font-bold text-slate-900">
              Uma IA que{" "}
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 md:row-span-2 rounded-2xl bg-white p-6 border border-slate-200">
              ...
              <div className="text-5xl text-slate-500 mt-1">
                Responde texto e áudio, entende contexto, lembra do cliente. Conversa de verdade.
              </div>

              <div className="mt-8 space-y-3">
                <div className="max-w-[70%] rounded-2xl bg-slate-100 px-4 py-2.5 text-5xl text-slate-800">
                  Oi, vi o anúncio. Tem disponível?
                </div>
                <div className="ml-auto max-w-[75%] rounded-2xl bg-gradient-to-br from-primary to-primary-dark px-4 py-2.5 text-5xl text-white">
      ...
      <section id="pagamentos" className="mx-auto max-w-6xl px-6 py-24">
        <div className="text-center">
          ...
          <h2 className="mt-3 text-5xl md:text-5xl font-bold tracking-tight">
            Receba pagamentos{" "}
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-6">
          ...
          <div className="rounded-3xl bg-white border border-slate-200 shadow-sm overflow-hidden flex flex-col">
            ...
            <div className="flex-1 p-5 space-y-3 bg-white">
              <div className="ml-auto max-w-[85%] rounded-2xl rounded-tr-sm bg-emerald-500 text-white px-4 py-3 text-5xl">
              ...
              <div className="max-w-[60%] rounded-2xl rounded-tl-sm bg-slate-100 text-slate-800 px-4 py-2 text-5xl">
                Pode mandar
              </div>
              <div className="ml-auto max-w-[85%] rounded-2xl rounded-tr-sm bg-emerald-500 text-white px-4 py-3 text-5xl space-y-2">
            ...
            <ul className="space-y-5">
              {[
                ...
                <li key={s.title} className="flex items-center gap-4">
                  <div className={`h-11 w-11 rounded-xl flex items-center justify-center text-5xl ${s.highlight ? "bg-violet-500 text-white" : "bg-slate-100"}`}>
                    {s.icon}
                  </div>
                  <div className="flex-1">
                    <div className="font-semibold text-5xl text-slate-900">{s.title}</div>
        ...
        <div className="mt-6 grid md:grid-cols-2 gap-6">
          <div className="rounded-3xl bg-white border border-slate-200 shadow-sm p-8 flex items-center justify-around">
            {[
              ...
              <div key={m.label} className="flex flex-col items-center gap-2 text-slate-600">
                ...
                <span className="text-5xl">{m.label}</span>
              </div>
            ))}
          </div>
          <div className="rounded-3xl bg-emerald-50 border border-emerald-100 p-8 flex flex-col justify-center">
            ...
            <p className="mt-2 text-5xl text-slate-600">
        ...
        <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={f.title} className="rounded-2xl bg-white border border-slate-200 p-5">
              ...
              <div className="font-semibold text-5xl text-slate-900">{f.title}</div>
      ...
      <section id="planos" className="bg-white py-24">
        <div className="mx-auto max-w-6xl px-6">
          <div className="text-center">
            ...
            <h2 className="mt-3 text-5xl md:text-5xl font-bold tracking-tight text-slate-900">
              Escolha o plano{" "}
            ...
            <div className="mt-8 inline-flex items-center gap-1 rounded-full bg-slate-100 border border-slate-200 p-1">
              <button
                ...
                className={`px-5 py-2 rounded-full text-5xl font-semibold transition ${billing === "monthly" ? "text-white" : "text-slate-600"}`}
              ...
              <button
                ...
                className={`px-5 py-2 rounded-full text-5xl font-semibold transition flex items-center gap-2 ${billing === "annual" ? "text-white" : "text-slate-600"}`}
          ...
          <div className="mt-14 grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <div className="rounded-3xl bg-white border border-slate-200 shadow-sm p-8">
              <div className="text-5xl font-bold text-slate-900">Start</div>
              <p className="mt-1 text-5xl text-slate-500">Para autônomos e pequenos times.</p>
              ...
              <ul className="mt-8 space-y-3 text-5xl text-slate-700">
                {[
                  "5 atendentes",
                  "2 conexões WhatsApp",
                  "IA completa",
            ...
            <div className="relative rounded-3xl bg-white border-2 p-8" style={{ borderColor: "#004DFF", boxShadow: "0 20px 60px -25px rgba(0, 77, 255, 0.4)" }}>
              ...
              <div className="text-5xl font-bold text-slate-900">Business</div>
              <p className="mt-1 text-5xl text-slate-500">Para equipes em crescimento.</p>
          ...
          <div className="mt-16 max-w-4xl mx-auto">
            <h3 className="text-center text-5xl font-bold text-slate-900">Compare os planos</h3>
            <p className="mt-2 text-center text-5xl text-slate-500">Veja lado a lado o que cada plano entrega.</p>

            <div className="mt-8 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
              <table className="w-full text-5xl">
                <thead>
      ...
      <section className="bg-gradient-to-b from-white to-slate-50 py-24">
        <div className="mx-auto max-w-6xl px-6 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="mt-5 text-5xl md:text-5xl font-bold tracking-tight leading-[1.1]">
              Sua <span style={{ color: "#004DFF" }}>voz clonada</span>,<br />
              respondendo por você.
            </h2>
            <p className="mt-5 text-slate-600 text-5xl leading-relaxed">
            ...
            <ul className="mt-6 space-y-3 text-5xl text-slate-700">
            ...
            <div className="grid grid-cols-3 gap-4 mt-8 pt-6 border-t border-slate-100">
              {[
                ...
                <div key={s.l} className="text-center">
                  <div className="text-5xl font-bold" style={{ color: "#004DFF" }}>{s.v}</div>
      ...
      <section id="segmentos" className="mx-auto max-w-5xl px-6 py-24">
        <div className="text-center">
          ...
          <h2 className="mt-4 text-5xl md:text-5xl font-bold font-space-grotesk">
            Funciona pro{" "}
        ...
        <div className="mt-14 grid grid-cols-2 md:grid-cols-3 gap-5">
          {segments.map((s) => (
            <div key={s.label} className="rounded-2xl border border-slate-200 bg-white px-6 py-8 text-center hover:border-primary/40 hover:shadow-sm transition-all">
              ...
              <div className="mt-4 text-5xl font-medium text-slate-700">{s.label}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="bg-slate-50 py-24">
        <div className="mx-auto max-w-6xl px-6">
          <div className="text-center">
            ...
            <h2 className="mt-4 text-5xl md:text-5xl font-bold">
            ...
            {[
              ...
              <div key={group.title} className="rounded-2xl bg-white border border-slate-200 p-6">
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div className="font-semibold text-5xl">{group.title}</div>
                </div>
                <div className="grid grid-cols-2 gap-2.5">
                  {group.items.map((it) => (
                    <div key={it.l} className="flex items-center gap-2.5 rounded-lg border border-slate-200 px-3 py-2.5 text-5xl text-slate-700">
              ...
              <div key={c.name} className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                <div className="flex items-center justify-between mb-5">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-semibold text-slate-900 text-5xl">{c.name}</div>
                ...
                <div className="mt-5 pt-5 border-t border-slate-100">
                  <div className="flex gap-2">
                    ...
                    <p className="text-5xl text-slate-600 leading-relaxed">{c.quote}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="mx-auto max-w-5xl px-6 pb-24">
        <div className="rounded-3xl bg-gradient-to-br from-primary to-primary-dark p-12 md:p-16 text-center text-white shadow-2xl">
          <h2 className="text-5xl md:text-5xl font-bold">Quero vender no automático.</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            ...
            <div className="lg:col-span-2 space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-5xl font-bold tracking-tight text-slate-900" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                <DialogTitle className="text-5xl">{selectedLead?.name}</DialogTitle>
